            ...
            <tbody>
                ...
                @foreach ($orders as $order)
                    <tr>
                        ...
                        <td>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $order->invoiceOrder->pickup_date)->format('M d,Y') }} at
                            {{ \Carbon\Carbon::createFromFormat('H:m:s', $order->invoiceOrder->pickup_time)->format('h:m a') }} </td>

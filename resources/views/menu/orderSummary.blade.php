...
@section('content')
    ...
    <div class="row w-75 p-5" style="margin: auto; background-color:rgba(75, 75, 75, 0.651)">
        ...
        <div class="col-md-8 order-md-1" style="color:white">
            ...
            <div class="form-check-inline">
                <input class="" type="radio" name="inlineRadioOptions" id="payment" value="1" onclick="credit()" checked>
            ...
            <div id="instore" style="display: none">
                <form action="{{ route('checkout.store') }}" method="POST">
                    ...
                    <hr style="height: 2px; background-color:orange">
                    <button class="btn btn-lg btn-block" style="background-color:orange; color:white" id="purchase" name="purchase" value='0' type="submit">Complete Order</button>
                </form>
            </div>
                    ...
                    <div style="display: show">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="cc-province" name="cc-province" placeholder=""
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
